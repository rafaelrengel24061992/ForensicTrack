...
import { ArrowLeft, Copy, Share2, Download, Trash2, MapPin, Globe, Smartphone, Sparkles, ExternalLink, RefreshCw, Check } from 'lucide-react';
...
export const CaseDetail: React.FC = () => {
  ...
  const copySpecificLink = (domain: string, index: number) => {
    // Mantendo o padrão de hash routing que o seu app usa (#/track/id)
  ...
  const downloadReport = () => {
    ...
    if (caseData.destinationUrl) doc.text(`Redirecionamento para: ${caseData.destinationUrl}`, 14, 44);
  ...
  return (
    <div className="p-4 max-w-4xl mx-auto space-y-6 pb-20">
      ...
      <div className="bg-white p-5 rounded-xl border border-blue-100 shadow-sm bg-gradient-to-br from-white to-blue-50">
        ...
        <p className="text-sm text-blue-700 mb-4">Escolha o domínio que deseja enviar para o alvo:</p>
                ...
                <div key={domain} className="flex flex-col sm:flex-row gap-2 items-center bg-white p-3 rounded-lg border border-blue-100">
                    ...
                    <div className="flex gap-2 w-full sm:w-auto">
                        ...
                        <Button 
                            ...
                            variant="ghost" 
                            className="h-9 px-3 border border-slate-200"
                        >
      ...
      <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
        ...
        {aiAnalysis ? (
            ...
            <div className="text-center py-6 text-slate-400 text-sm">Pronto para analisar os logs.</div>
        )}
      </div>
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-end">
            ...
            <Button onClick={downloadReport} variant="secondary" className="text-sm py-